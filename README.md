...
The methodology follows Pappas et al. (2024) *On the economic feasibility of tidal range power plants*, and Pappas et al. (2023) *Sensitivity of tidal range assessments to harmonic constituents and analysis timeframe*  and the turbine performance model is based on Angeloudis et al. (2018) *Optimising tidal range power plant operation*.
